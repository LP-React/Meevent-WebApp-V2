...
export default function RegisterPage() {
    ...
    return (
        <div>
            <div className="bg-[url('/bg2.jpg')] bg-black/55 bg-blend-multiply grid  grid-cols-1 sm:grid-cols-1 sm:p-0 gap-3 bg-cover h-dvh md:p-4 lg:grid-cols-[2fr_1.5fr] xl:grid-cols-[1.8fr_2fr]">
